...
const lossTimeline = [
    ...
    { start: 23, action: () => triggers.trigger6 = true },
    { start: 25, action: () => triggers.trigger7 = true },
    { start: 28, action: () => triggers.trigger8 = true },
    { start: 32, action: () => triggers.trigger9 = true },
    { start: 35, end: 36, speaker: 'hunter', text: "...you" },
    { start: 36, end: 37, speaker: 'hunter', text: "...you are" },
    { start: 37, end: 38, speaker: 'hunter', text: "...you are not" },
    { start: 38, end: 44, speaker: 'hunter', text: "...you are not Sophie..." },
    { start: 47, action: () => textSpawn = min(textSpawn + 3, 255) },
]
